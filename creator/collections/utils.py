# Утилиты для работы с коллекциями ChromaDB, которые используются для быстрого поиска моделей по тегам и категориям
import os
import chromadb
import pandas as pd
import questionary
...
# Для генерации индексов для моделей, чтобы потом быстро находить модели по запросу
def fill_index(collection, loader: BaseLoader):
 ...
 # Получаем коллекцию ChromaDB, если она есть, иначе создаем и заполняем ее
