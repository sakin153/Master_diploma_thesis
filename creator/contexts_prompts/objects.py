...
- Descriptions must be visually rich but only about the object itself, physically plausible,
...
```json
[
  {"name": "shelf", "description": "A wall-mounted wooden shelf made of light oak, rectangular shape, smooth polished surface, visible wood grain texture, minimalistic design."},
  {"name": "shelf", "description": "A wall-mounted wooden shelf made of light oak, rectangular shape, smooth polished surface, visible wood grain texture, minimalistic design."}
]
```
...
```json
[
  {"name": "armchair", "description": "A cozy upholstered armchair with soft beige fabric, rounded armrests, thick cushioned seat, wooden legs, slightly reclined backrest."},
  {"name": "armchair", "description": "A cozy upholstered armchair with soft beige fabric, rounded armrests, thick cushioned seat, wooden legs, slightly reclined backrest."},
  {"name": "coffee table", "description": "A low rectangular coffee table with a dark walnut wooden top, black metal frame, clean modern design, smooth matte finish."}
]
```
...
```json
[
  {"name": "bed", "description": "A queen-size bed with a soft gray upholstered headboard, white mattress, neatly arranged pillows and blanket, modern minimalist style."},
  {"name": "nightstand", "description": "A small wooden nightstand with a single drawer, light oak finish, compact rectangular shape, minimalistic design."},
  {"name": "nightstand", "description": "A small wooden nightstand with a single drawer, light oak finish, compact rectangular shape, minimalistic design."},
  {"name": "dresser", "description": "A medium-sized wooden dresser with six drawers, dark brown finish, metal handles, rectangular shape, smooth polished surface."}
]
```
